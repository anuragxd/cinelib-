    ...
    <footer className="border-t border-gray-200 bg-white mt-auto">
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-lg font-bold">CineLib</span>
            </div>
            <p className="text-sm text-gray-600">
              Your ultimate movie community platform. Discover, share, and curate your favorite films.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/playlists" className="text-gray-600 hover:text-primary transition-colors">
                  Playlists
                </Link>
              </li>
              <li>
                <Link href="/recommendations" className="text-gray-600 hover:text-primary transition-colors">
                  Recommendations
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} CineLib. All rights reserved.
          </p>
